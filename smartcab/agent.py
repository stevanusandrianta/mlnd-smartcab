...
#         self.epsilon -= 0.05
    ...
    def get_maxQ(self, state):
        ...
        max_value = max([self.Q[state_string][a] for a in self.valid_actions])
        maxQ_list = [a for a in self.valid_actions if self.Q[state_string][a] == max_value]
        
        return random.choice(maxQ_list)
